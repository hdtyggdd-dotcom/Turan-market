...
export const categories: StoredCategory[] = [
  ...
  },
  {
    ...
    icon: "🛠️",
    subcategories: [
      { id: 'sub48', name: "Texnika ijarasi",  nameRu: "Аренда техники",    categoryId: 'cat7', bookingMode: 'full' },
      { id: 'sub49', name: "Qurilish xizmati", nameRu: "Строительные услуги", categoryId: 'cat7', bookingMode: 'showcase' },
      { id: 'sub50', name: "Transport",        nameRu: "Транспорт",          categoryId: 'cat7', bookingMode: 'showcase' },
      { id: 'sub51', name: "Boshqa xizmat",    nameRu: "Другие услуги",      categoryId: 'cat7', bookingMode: 'showcase' },
    ],
  },
];
