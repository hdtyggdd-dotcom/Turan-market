...
export const categories: StoredCategory[] = [
  ...
  },
  {
    ...
    icon: "🏗️",
    subcategories: [
      { id: 'sub12', name: "Armatura",       nameRu: "Арматура",        categoryId: 'cat2' },
      { id: 'sub13', name: "G'isht",         nameRu: "Кирпич",          categoryId: 'cat2' },
      { id: 'sub14', name: "Shpagilovka",    nameRu: "Шпаклёвка",       categoryId: 'cat2' },
      { id: 'sub15', name: "Sement",         nameRu: "Цемент",          categoryId: 'cat2' },
      { id: 'sub16', name: "Shifer",         nameRu: "Шифер",           categoryId: 'cat2' },
      { id: 'sub17', name: "Reka tosh",      nameRu: "Речной камень",   categoryId: 'cat2' },
      { id: 'sub18', name: "Pol taxta",      nameRu: "Напольная доска", categoryId: 'cat2' },
      { id: 'sub19', name: "Mis (miq)",      nameRu: "Медь",            categoryId: 'cat2' },
      { id: 'sub20', name: "Qum va shag'al", nameRu: "Песок и щебень",  categoryId: 'cat2' },
      { id: 'sub21', name: "Ohak",           nameRu: "Известь",         categoryId: 'cat2' },
      { id: 'sub22', name: "Boshqa qurilish",nameRu: "Прочие материалы",categoryId: 'cat2' },
    ],
  },
  {
    id: 'cat3',
  ...
  },
  {
    ...
    icon: "🌾",
    subcategories: [
      { id: 'sub36', name: "Urug' va ko'chat",      nameRu: "Семена и саженцы",     categoryId: 'cat5' },
      { id: 'sub37', name: "O'g'it va kimyo",        nameRu: "Удобрения и химия",    categoryId: 'cat5' },
      { id: 'sub38', name: "Sabzavot va meva",       nameRu: "Овощи и фрукты",       categoryId: 'cat5' },
  ...
  {
    id: 'cat6',
    name: "Boshqa tovarlar",
    nameRu: "Другие товары",
    icon: "📦",
    subcategories: [
  ...
  {
    id: 'cat7',
    name: "Maxsus xizmatlar",
    nameRu: "Спецуслуги",
    icon: "⚙️",
    subcategories: [
      { id: 'sub48', name: "Agro dron xizmati",    nameRu: "Агродрон",            categoryId: 'cat7', bookingMode: 'full' },
      { id: 'sub49', name: "Ekskavator xizmati",   nameRu: "Экскаватор",          categoryId: 'cat7', bookingMode: 'full' },
      { id: 'sub50', name: "Traktor xizmati",      nameRu: "Трактор (услуги)",    categoryId: 'cat7', bookingMode: 'full' },
      { id: 'sub51', name: "Qurilish xizmati",     nameRu: "Строительные услуги", categoryId: 'cat7', bookingMode: 'showcase' },
      { id: 'sub52', name: "Transport xizmati",    nameRu: "Транспортные услуги", categoryId: 'cat7', bookingMode: 'showcase' },
      { id: 'sub53', name: "Tozalash xizmati",     nameRu: "Клининг",             categoryId: 'cat7', bookingMode: 'showcase' },
      { id: 'sub54', name: "Boshqa xizmat",        nameRu: "Другие услуги",       categoryId: 'cat7', bookingMode: 'showcase' },
    ],
  },
  {
    id: 'cat8',
